...
const zhCN: Dict = {
  ...
  dangerZone: '危险操作',
  confirmResetLayout: '确定重置所有节点布局？已保存的节点位置会丢失。',
  confirmYes: '确定',
  confirmTypeHint: '请输入 {word} 以确认删除全部 {count} 个实体（不可撤销）',
  confirmWord: '清空',
  confirmClearAction: '永久清空',
  stats: '统计',
  entityCount: '实体总数',
  relationCount: '关联数量',
  about: '关于',
...
const zhTW: Dict = {
  ...
  dangerZone: '危險操作',
  confirmResetLayout: '確定重設所有節點佈局？已儲存的節點位置會遺失。',
  confirmYes: '確定',
  confirmTypeHint: '請輸入 {word} 以確認刪除全部 {count} 個實體（無法復原）',
  confirmWord: '清空',
  confirmClearAction: '永久清空',
  stats: '統計',
  entityCount: '實體總數',
...
const en: Dict = {
  ...
  confirmResetLayout: 'Reset all node positions? Saved positions will be lost.',
  confirmYes: 'Confirm',
  confirmTypeHint: 'Type {word} to delete all {count} entities (cannot be undone)',
  confirmWord: 'CLEAR',
  confirmClearAction: 'Delete everything',
  stats: 'Stats',
